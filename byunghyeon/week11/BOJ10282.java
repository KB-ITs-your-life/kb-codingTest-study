...
//
//            // 그래프 초기화
//            List<BOJ2458.Node>[] graph = new ArrayList[n+1];
//            for(int j = 0; j <= n; j++){
...
//
//                graph[b].add(new BOJ2458.Node(a, s));
//            }
//
//            // 다익스트라
//            PriorityQueue<BOJ2458.Node> pq = new PriorityQueue<>();
//            int[] times = new int[n+1];
//            Arrays.fill(times, Integer.MAX_VALUE);
//            pq.add(new BOJ2458.Node(c, 0));
//            times[c] = 0;
//
//            while(!pq.isEmpty()){
//                BOJ2458.Node cur = pq.poll();
//                int curTime = cur.time;
//
//                if(times[cur.to] < curTime) continue;
//                if(graph[cur.to].isEmpty()) continue;
//
//                for(BOJ2458.Node next : graph[cur.to]){
//                    if(times[next.to] > times[cur.to] + next.time){
//                        times[next.to] = times[cur.to] + next.time;
//                        pq.add(new BOJ2458.Node(next.to, times[next.to]));
//                    }
//                }
//            }
//            // 끝
...
//    }
//
//    static class Node implements Comparable<BOJ2458.Node>{
//        int to;
//        int time;
...
//
//        @Override
//        public int compareTo(BOJ2458.Node o) {
